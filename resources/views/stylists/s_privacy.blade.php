@extends('layouts.stylist2_app')

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1><strong>Privacy and Security</strong></h1>
